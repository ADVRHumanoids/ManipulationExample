...
/* Specify that the class XBotPlugin::ManipulationExample1 is a XBot RT plugin with name "ManipulationExample1" */
...
void ManipulationExample::on_start(double time)
{
     ...
     * is sent over the plugin switch port (e.g. 'rosservice call /ManipulationExample1_switch true').
...
void ManipulationExample::on_stop(double time)
{
     ...
     * is sent over the plugin switch port (e.g. 'rosservice call /ManipulationExample1_switch false').
     * Since this function is called within the real-time loop, you should not perform
     * operations that are not rt-safe. */
}
...
void ManipulationExample::control_loop(double time, double period)
{
     ...
     *         rosservice call /ManipulationExample1_cmd "cmd: 'MY_COMMAND_1'"
